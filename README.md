...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Dynamic Analysis with Frida**<br>Frida ile Dinamik Analiz                    | [researchs/frida_dynamic_analysis.md](researchs/frida_dynamic_analysis.md)                          | In-depth analysis of Frida’s usage in mobile app security testing and in-app hooking mechanisms.<br>Frida'nın mobil uygulama güvenliği testlerindeki kullanımı ve uygulama içi hook mekanizmaları üzerine derinlemesine analiz. |
| **Sensitive Data Leakage Techniques**<br>Hassas Veri Sızıntı Teknikleri        | [data\_leak\_techniques.md](researchs/data_leak_techniques.md)                              | A study on logging errors and other common sensitive data leakage vectors.<br>Loglama hataları ve diğer yaygın hassas veri sızıntı vektörleri üzerine bir inceleme.                                                             |
