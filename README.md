...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Dynamic Analysis with Frida**<br>Frida ile Dinamik Analiz                    | [frida\_dynamic\_analysis.md](researchs/frida_dynamic_analysis.md)                          | In-depth analysis of Frida’s usage in mobile app security testing and in-app hooking mechanisms.<br>Frida'nın mobil uygulama güvenliği testlerindeki kullanımı ve uygulama içi hook mekanizmaları üzerine derinlemesine analiz. |
